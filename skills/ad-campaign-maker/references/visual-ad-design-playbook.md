...
- Conversion cue: discount, demo, testimonial, before/after, comparison, guarantee, limited-time cue, QR/link/CTA.
...
| Problem → solution → result | pain-point ads, lead gen | Three zones or panels; keep labels short; product appears in solution/result zone. |
...
| UGC native frame | Douyin/TikTok/Xiaohongshu | Looks like phone capture; handwritten/marker-style overlay; imperfect but readable composition. |
...
- Premium/luxury: large negative space, low-saturation palette, single hero object, soft directional light, restrained serif/sans typography, no clutter.
...
- B2B authority: clean white/blue/gray palette, dashboard/screenshot, proof metric, role-specific headline, low-friction CTA.
